   ...
   <div class="container">
	...
	<div class="row mt-3">
        ...
        <th width="180">NAME</th>
          <td><input type="text" class="form-control form-control-user <?= validation_show_error("name") ? 'is-invalid' : '';?>" name="name"  value="<?= old('name')?>" id="name" placeholder="Name" autofocus>
        ...
        <th>PHONE NUMBER</th>
          <td><input type="number" class="form-control form-control-user <?= validation_show_error("phone_number") ? 'is-invalid' : '';?>" name="phone_number" id="phone_number" value="<?= old('phone_number')?>" placeholder="Phone number">
          <div class="invalid-feedback">
        ...
        <th>PLACE AND DATE OF BIRTH</th>
          <td> 
            <input type="text" class="form-control <?= validation_show_error("place") ? 'is-invalid' : '';?>" id="place" name="place" placeholder="Tempat" value="<?= old('place'); ?>">
            <div class="invalid-feedback">
                <?= validation_show_error("place"); ?>
            </div>
            <input type="date" class="form-control <?= validation_show_error("date_birth") ? 'is-invalid' : '';?>" id="date_birth" name="date_birth" placeholder="date_birth" value="<?= old('date_birth'); ?>">
            <div class="invalid-feedback">
        ...
        <th>ADDRESS</th>
            <td>
                <textarea class="form-control <?= validation_show_error("address") ? 'is-invalid' : '';?>" id="exampleFormControlTextarea1" placeholder="Address" name="address" rows="3"><?= old('address'); ?>
                </textarea>
                <div class="invalid-feedback">
        ...
        <tr>
            <th>HIRE DATE</th>
            <td>
            <input type="date" class="form-control <?= validation_show_error("hire_date") ? 'is-invalid' : '';?>" id="hire_date" name="hire_date" placeholder="hire_date" value="<?= old('hire_date'); ?>">
            <div class="invalid-feedback">
        ...
        <th>STATUS</th>
          <td>
            ...
            <option value="" selected>Select status employee</option>
